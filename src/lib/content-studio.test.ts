  ...
  it("exige exatamente três ideias e três variações de automação", () => {
    ...
    const richResult = richContentPackageSchema.safeParse({
      ...
      deliverable: {
        ...
        executionFlow: [
          { action: "prepare", title: "Separe um caso", instruction: "Abra uma tarefa concluída nesta semana e separe a entrada e a saída.", copyableContent: "", customization: [], expectedResult: "Uma entrada e uma saída estarão abertas." },
          { action: "copy", title: "Copie o diagnóstico", instruction: "Copie o prompt e substitua os campos entre colchetes.", copyableContent: "Analise esta tarefa: [TAREFA].\nEntrada: [ENTRADA].\nSaída: [SAÍDA].", customization: ["Troque [TAREFA] pelo nome real"], expectedResult: "Um recorte adequado será sugerido." },
          { action: "use", title: "Use na IA", instruction: "Cole o prompt preenchido na inteligência artificial que você já utiliza.", copyableContent: "", customization: [], expectedResult: "A IA devolverá critérios e casos de teste." },
          { action: "apply", title: "Teste o resultado", instruction: "Rode os casos sugeridos e compare todos pelos mesmos critérios.", copyableContent: "", customization: [], expectedResult: "Você terá uma decisão de adotar, ajustar ou descartar." },
        ],
        resultPrompt: "Cole aqui o prompt final e a tabela que a IA preparou.",
        resultPlaceholder: "Prompt final...\n\nTabela de avaliação...",
        finalApplication: "Rode o prompt nos três casos e mantenha revisão humana até todos serem aprovados.",
