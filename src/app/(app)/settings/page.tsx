...
import { ArrowRight, AtSign, BookOpenCheck, CheckCircle2, Clock3, Link2, RefreshCw, ShieldCheck } from "lucide-react";
...
export default async function SettingsPage({ searchParams }: { searchParams: Promise<{ sync?: string; count?: string; error?: string }> }) {
